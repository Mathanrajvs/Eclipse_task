	...
	<li class="dropdown">
		<a href="javascript:void(0)" class="dropbtn">Resources</a>
			<div class="dropdown-content">
			      ...
			      <a href="#"class="active">Webinars</a>
...
<div>
<img src="images/task26.JPG" alt="not found" style="width:100%;height:25%;"/>
</div>
<br><br>
<img src="images/task27.JPG" alt="job" style="width:45%;height:40%;margin-left:70px;margin-top:60px;"/>

 <div class="contact_form">
                  
                   <h1>Register Now</h1>
                   <form action="webinarProcess.jsp">
                    <div class="form_row">
					...
					<input type="submit" class="read_more" value="Register"/>      
					</form>        
